...
| session | `data/automod-session.ts` | `check-automod` (27) | dedupe within 1 s; slot within 2 s; late tail reported |
...
| publish | `data/automod-publish.ts` | `check-strip-life` (44), `check-automod` (27) | the decision the controller cannot be gated on, driven directly: four known rows, a learned row, an unknown row, the Mods segment, idle |
...
| optimise | `data/optimise.ts` (Q1, Q2, Q3) | `check-optimise` (58) | 225 ms for a weapon, 456 ms for a frame, on an account owning everything; Ideal Braton 60/60 = Primed Cryo Rounds 10 · Serration 10 · Heavy Caliber 7 · Vigilante Armaments 5 · Vile Acceleration 4 → 3,755 dps; 49 of 85 eligible mods scored by Q1 |
